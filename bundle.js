...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameStateApi = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BALL_DIAMETER = exports.BALL_DIAMETER = 50;
	var WALL_LENGTH = exports.WALL_LENGTH = 1000;
	var PADDLE_THICKNESS = exports.PADDLE_THICKNESS = 10;
	var PADDLE_WIDTH = exports.PADDLE_WIDTH = 150;
	var SMALLEST_ANGLE = exports.SMALLEST_ANGLE = 25;
	var PADDLE_VECTOR = exports.PADDLE_VECTOR = { x: 6, y: 0 };
	...
	var PaddleInfo = exports.PaddleInfo = {
	    player1: Coordinate, // Center of the paddle
	    player2: Coordinate
	};

	var BallInfo = exports.BallInfo = {
	    ballLocation: Coordinate,
	    ballVector: Coordinate
	};

	var PaddleDirections = exports.PaddleDirections = {
	    player1: "", // Acceptable values are 'left' and 'right'
	    player2: "" };

	var Coordinate = exports.Coordinate = { x: 0, y: 0 };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Info = exports.Info = React.createClass({ displayName: "Info",
	    render: function () {
	        var gameState = this.props.gameState;
	        var api = this.props.api;
	        return React.createElement("div", null, React.createElement(Score, { score: gameState.score.player1, currentState: gameState.currentState, player: "player1" }), React.createElement(Score, { score: gameState.score.player2, currentState: gameState.currentState, player: "player2" }), React.createElement(GameInfo, { gameState: gameState, api: api }));
	    }
	});
	...
	var GameInfo = React.createClass({ displayName: "GameInfo",
	    render: function () {
	        ...
	        return React.createElement(GameInfoAction, { key: key, keyHandler: keyHandler, largeMessage: largeMessage, instructions: instructions, keyInstruction: keyInstruction, currentState: currentState });
	    }
	});
	...
	var GameInfoAction = React.createClass({ displayName: "GameInfoAction",
	    ...
	    render: function () {
	        ...
	        var instructionStyle = {
	            ...
	            fontSize: "30px",
	            textAlign: "center" };
	        var renderedInstructions = _.map(instructions, function (instruction) {
	            return React.createElement("div", { style: instructionStyle }, instruction);
	        });
	        if (currentState == cst.CurrentState.Beginning) {
	            aiControls = React.createElement("div", { style: instructionStyle }, React.createElement(AiSelector, { player: "player1" }), React.createElement(AiSelector, { player: "player2" }), React.createElement(AiDifficulty, null));
	        }
	        return React.createElement("div", { style: gameInfoStyle }, React.createElement("div", { style: largeMessageStyle }, largeMessage), aiControls, renderedInstructions);
	    }
	});

	var AiDifficulty = React.createClass({ displayName: "AiDifficulty",
	    ...
	    selectEasy: function () {
	        return this.selectDifficulty("easy");
	    },
	    selectMedium: function () {
	        return this.selectDifficulty("medium");
	    },
	    selectHard: function () {
	        return this.selectDifficulty("hard");
	    },
	    render: function () {
	        ...
	        var hardClasses = classnames({
	            ...
	            link: true });
	        return React.createElement("div", null, React.createElement("span", null, "Comp difficulty: "), React.createElement("span", { className: easyClasses, onClick: this.selectEasy }, "Easy "), React.createElement("span", { className: mediumClasses, onClick: this.selectMedium }, "Medium "), React.createElement("span", { className: hardClasses, onClick: this.selectHard }, "Hard "));
	    }
	});

	var AiSelector = React.createClass({ displayName: "AiSelector",
	    getInitialState: function () {
	        return this.getSelectedState();
	    },
	    getSelectedState: function () {
	    ...
	    selectHuman: function () {
	        var _this = this;
	        _.remove(ai.players, function (player) {
	            return _this.props.player == player;
	        });
	        this.setState(this.getSelectedState());
	    },
	    ...
	    render: function () {
	        ...
	        var computerClasses = classnames({
	            selected: !this.state.humanSelected,
	            link: true });
	        return React.createElement("div", null, formattedPlayerString(player), " ", React.createElement("span", { onClick: this.selectHuman, className: humanClasses }, "Human"), " ", React.createElement("span", { onClick: this.selectComputer, className: computerClasses }, "Computer"));
	    }
	});
	...
	var Score = React.createClass({ displayName: "Score",
	    render: function () {
	        ...
	        var scoreStyle = _.merge({
	            ...
	            color: scoreColor,
	            fontFamily: "VT323",
	            fontSize: "30px" }, scoreLocation);
	        return React.createElement("div", { style: scoreStyle }, React.createElement("div", null, formattedPlayerString(player), ": ", score));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Currently this ratio is 1, but this way I don't *depend* on it being 1

	exports.render = render;
	var cst = __webpack_require__(3);
	var styles = __webpack_require__(7);
	var canvasWallLength = cst.WALL_LENGTH;
	var conversionFactor = canvasWallLength / cst.WALL_LENGTH;function render(gameState) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var white = exports.white = "#EBEBEB";
	var gray = exports.gray = "#222222";
	var lightGray = exports.lightGray = "#444444";
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.attachKeyListeners = attachKeyListeners;
	exports.startPaddleInfo = startPaddleInfo;
	exports.genericPaddleInfo = genericPaddleInfo;
	exports.newPaddleLocations = newPaddleLocations;
	...
	function genericPaddleInfo(player1Coord, player2Coord) {
	    return {
	        player1: player1Coord,
	        player2: player2Coord };
	}

	function newPaddleLocations(oldPaddleInfo, paddleDirections) {
	...
	function movePaddleCoordinate(coordinate, direction) {
	    if (!direction) {
	        ...
	        return movePaddleLeft(coordinate);
	    } else if (direction == "right") {
	        return movePaddleRight(coordinate);
	    }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function newScoreInfo(prevScore, potentialBallLocation) {
	...
	function currentStatePerScore(oldScoreInfo, newScoreInfo) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function bounceX(vector) {
	    return { x: -vector.x, y: vector.y };
	}

	function bounceY(vector) {
	    return { x: vector.x, y: -vector.y };
	}

	function getRectanglePoints(coordinate, rectWidth, rectHeight) {
	    return {
	...
	function rectanglesIntersect(rect1, rect2) {
	    return !(rect1.maxX < rect2.minX || rect1.minX > rect2.maxX || rect1.minY > rect2.maxY || rect1.maxY < rect2.minY);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function move(gameState) {
	    _.forEach(gameState.ai.players, function (player) {
	        return makeMove(player, gameState.ai.difficulty, gameState.ballInfo, gameState.paddleInfo);
	    });
	}
